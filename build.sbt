...
name := "delta-metadata-to-glue-metadata-converter"
organization := "com.samrat"
version := "0.0.1"
...
// resolvers += "redshift" at "https://redshift-maven-repository.s3-website-us-east-1.amazonaws.com/release"
